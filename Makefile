...
abs_builddir = /home/minjin/work/libcoap-code
top_builddir = .
package = libcoap-4.1.2
prefix = /usr/local
...
SOURCES:= pdu.c net.c debug.c encode.c uri.c coap_list.c resource.c hashkey.c \
	 str.c option.c async.c subscribe.c block.c mem.c coap_io.c
...
HEADERS:=coap.h config.h debug.h pdu.h net.h encode.h uri.h coap_list.h mem.h \
	...
	subscribe.h block.h address.h prng.h coap_time.h t_list.h  coap_io.h
