/*
	build : gcc -o resource_client resource_client.c
	execution : ./resource_client 127.0.0.1 2048 1 2900 1 20
	1. ./resource_client 127.0.0.1 2048 0[request] 800[interval]
	2. ./resource_client 127.0.0.1 2048 0[request] 800[interval]
	3. ./resource_client 127.0.0.1 2048 1[observe] 800[interval]
	4. ./resource_client 127.0.0.1 2048 1[observe] 800[interval]
	5. ./resource_client 127.0.0.1 2048 1[observe] 800[interval]
	6. ./resource_client 127.0.0.1 2048 1[observe] 800[interval] 1[log_file] 20[log_count]
*/
