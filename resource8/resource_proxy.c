/*
	...
	execution : ./resource_proxy 2048 127.0.0.1 1024 1 0
...
1. normal RESTful interface
2. resource cache in proxy
6. Interval-Tolerant Resource Monitoring Method interval
*/
